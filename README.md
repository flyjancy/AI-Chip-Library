...
| You Only Cache Once: Decoder-Decoder Architectures for Language Models | 2024 | Architecture / NPU | [深度分析](Architecture/NPU/summary-You-Only-Cache-Once-Decoder-Decoder-Architectures-for-Language-Models.md) | LLM Inference、KV Cache、Gated Retention、Long Context、Prefill |
